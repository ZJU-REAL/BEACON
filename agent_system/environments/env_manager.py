...
def make_envs(config):
    ...
    if "search" in config.env.env_name.lower():
        ...
        # Use the jar bundled with the pip-installed scienceworld package
        jar_path = None

        # Prepare environment kwargs (like WebShop's env_kwargs)
        env_kwargs = {
            'jar_path': jar_path,
        ...
        # Build environments (same signature as WebShop)
